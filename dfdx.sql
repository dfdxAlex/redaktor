...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 03 2023 г., 18:32
...
CREATE TABLE `bd2` (
  ...
  `login_redaktora` varchar(200) DEFAULT NULL,
  `razdel` varchar(100) DEFAULT NULL
...
CREATE TABLE `cv_json` (
  ...
  `json_name` varchar(50) DEFAULT NULL,
  `json_str` varchar(10000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `nastrolkiredaktora` (
  `imiePosTabl` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `nie_maty` (
  `nie_mat` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `redakt_profil` (
  ...
  `poz1` varchar(255) DEFAULT NULL,
  `poz2` varchar(255) DEFAULT NULL,
  `poz3` varchar(255) DEFAULT NULL,
  `poz4` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `redakt_profil_tegi` (
  `stolb` int(11) DEFAULT NULL,
  `str` int(11) DEFAULT NULL,
  `name_teg` varchar(255) DEFAULT NULL,
  `name_attrib` varchar(255) DEFAULT NULL,
...
CREATE TABLE `slegka_dfdx` (
  `id` int(11) DEFAULT NULL,
  `metka` varchar(500) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Таблица будет содержать статистику запросов к другим таблица';
...
CREATE TABLE `tic_tac_toe` (
  ...
  `rezult` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
