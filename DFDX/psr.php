...
//файл сгенерирован CMS-DFDX 2022-02-13 23:58:19
//file generated CMS-DFDX 2022-02-13 23:58:19
session_start();
require "funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>psr</title>');
...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('image/home.png','psr');   
...
$metka="psr"; //метка для счётчика статистики посещения конкретной страницы
...
$nonTemplates->publishNews($redaktor,'action=psr.php','Число_статей=5',-1,$nameBD,'категория-psr','Раздел=psr','buttonTwitter');
