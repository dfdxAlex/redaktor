...
//$_SESSION['redaktiruem']="apidfdx.php";
 ...
 if (!$bylPoisk)
 {
   ...
   // } else // добавить if (false)   //маркер 
    //   {
     ...
     //   $redaktor->news1("id=".$id,$nameBD,"Заголовок=h3","Статус редактора=-s45","Статус редактора=-s12345","Шаблон=2","Отступ=1",$action,'Раздел=apidfdx');
     //  }
  }
