...
require "class.php";
  ...
  $header = new Header();
  $futter = new futter();
  $nonTemplates = new NonTemplates(); // привет
...
$nonTemplates->publishNews($redaktor,'action=apidfdx.php','Число_статей=5',-1,$nameBD,'категория-apidfdx','Раздел=apidfdx','buttonTwitter');
