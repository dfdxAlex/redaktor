...
<title>&lt!DOCTYPE&gt - объявление типа документа.</title>
...
$runNewsIsNews1=2;
$metka='-lt-doctype-gt-obyavlenie-tipa-dokumenta-'; //метка для счётчика статистики посещения конкретной страницы
...
//маркер
 if (!$bylPoisk)
 {
  ...
  buttonTwitter("&lt!DOCTYPE&gt - объявление типа документа. http://dfdx.uxp.ru/news/html3html5xhtml/lt-doctype-gt-obyavlenie-tipa-dokumenta-double-1641492447.php");
