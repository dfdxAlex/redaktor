...
echo '<head>';
  ...
  $header->headStart('<title>28</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',28,$nameBD,'#категория для поиска#','Раздел=regular_expressions','28 http://dfdx.uxp.ru/news/html3html5xhtml/struktura-html-stranicy.php');
