...
//файл сгенерирован CMS-DFDX 2022-02-09 23:07:13
//file generated CMS-DFDX 2022-02-09 23:07:13
session_start();
include "../../funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>Структура HTML страницы.</title>');
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=28;
        $metka='struktura-html-stranicy-'; //метка для счётчика статистики посещения конкретной страницы
...
buttonTwitter("Структура HTML страницы. http://dfdx.uxp.ru/news/html3html5xhtml/struktura-html-stranicy.php");
