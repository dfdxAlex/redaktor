...
echo '<head>';
  ...
  $header->headStart('<title>29</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',29,$nameBD,'#категория для поиска#','Раздел=regular_expressions','29 http://dfdx.uxp.ru/news/html3html5xhtml/zagolovki-hh.php');
