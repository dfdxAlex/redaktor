...
//файл сгенерирован CMS-DFDX 2022-03-06 01:40:18
//file generated CMS-DFDX 2022-03-06 01:40:18
session_start();
...
echo '<head>';
  ...
  $header->headStart('<title>2</title>');
...
$metka='-lt-doctype-gt-obyavlenie-tipa-dokumenta-'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',2,$nameBD,'#категория для поиска#','Раздел=regular_expressions','2 http://dfdx.uxp.ru/news/html3html5xhtml/lt-doctype-gt-obyavlenie-tipa-dokumenta.php');
