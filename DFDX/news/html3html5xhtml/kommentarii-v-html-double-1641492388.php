...
$runNewsIsNews1=0;
$metka='kommentarii-v-html-'; //метка для счётчика статистики посещения конкретной страницы
...
//маркер
 if (!$bylPoisk)
 {
  ...
  buttonTwitter("Комментарии в html. http://dfdx.uxp.ru/news/html3html5xhtml/kommentarii-v-html-double-1641492388.php");
