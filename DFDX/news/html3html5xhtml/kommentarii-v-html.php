...
//файл сгенерирован CMS-DFDX 2022-03-06 10:13:47
//file generated CMS-DFDX 2022-03-06 10:13:47
session_start();
...
echo '<head>';
  ...
  $header->headStart('<title>0</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',0,$nameBD,'#категория для поиска#','Раздел=regular_expressions','0 http://dfdx.uxp.ru/news/html3html5xhtml/kommentarii-v-html.php');
