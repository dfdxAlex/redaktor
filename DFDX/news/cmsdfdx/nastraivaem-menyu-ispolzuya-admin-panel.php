...
echo '<head>';
  ...
  $header->headStart('<title>16</title>');
...
$metka='nastraivaem-menyu-ispolzuya-admin-panel-'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',16,$nameBD,'#категория для поиска#','Раздел=regular_expressions','16 http://dfdx.uxp.ru/news/cmsdfdx/nastraivaem-menyu-ispolzuya-admin-panel.php');
