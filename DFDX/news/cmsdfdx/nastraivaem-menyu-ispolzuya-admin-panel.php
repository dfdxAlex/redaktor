...
//файл сгенерирован CMS-DFDX 2022-02-06 14:59:53
//file generated CMS-DFDX 2022-02-06 14:59:53
session_start();
include "../../funcii.php";
...
<title>Настраиваем меню используя админ-панель.</title>
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=16;
        $metka='nastraivaem-menyu-ispolzuya-admin-panel-'; //метка для счётчика статистики посещения конкретной страницы
        ...
        if (!$bylPoisk) {
          ...
          buttonTwitter("Настраиваем меню используя админ-панель. http://dfdx.uxp.ru/news/cmsdfdx/nastraivaem-menyu-ispolzuya-admin-panel.php");
