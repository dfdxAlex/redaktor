...
echo '<head>';
  ...
  $header->headStart('<title>15</title>');
...
$metka='kak-opublikovat-statyu-na-sayte-s-cms-dfdx-'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',15,$nameBD,'#категория для поиска#','Раздел=regular_expressions','15 http://dfdx.uxp.ru/news/cmsdfdx/kak-opublikovat-statyu-na-sayte-s-cms-dfdx.php');
