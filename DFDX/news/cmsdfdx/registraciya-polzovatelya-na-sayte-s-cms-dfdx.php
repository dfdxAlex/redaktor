...
echo '<head>';
  ...
  $header->headStart('<title>13</title>');
...
$metka='registraciya-polzovatelya-na-sayte-s-cms-dfdx'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',13,$nameBD,'#категория для поиска#','Раздел=regular_expressions','13 http://dfdx.uxp.ru/news/cmsdfdx/registraciya-polzovatelya-na-sayte-s-cms-dfdx.php');
