...
echo '<head>';
  ...
  $header->headStart('<title>26</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',26,$nameBD,'#категория для поиска#','Раздел=regular_expressions','26 http://dfdx.uxp.ru/news/cmsdfdx/dorabotka-redaktora-new-cms-dfdx.php');
