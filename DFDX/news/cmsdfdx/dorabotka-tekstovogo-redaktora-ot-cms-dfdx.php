...
<title>Доработка текстового редактора от CMS-DFDX</title>
...
$runNewsIsNews1=18;
$metka='dorabotka-tekstovogo-redaktora-ot-cms-dfdx'; //метка для счётчика статистики посещения конкретной страницы
...
//маркер
 if (!$bylPoisk)
 {
  ...
  buttonTwitter("Доработка текстового редактора от CMS-DFDX http://dfdx.uxp.ru/news/cmsdfdx/dorabotka-tekstovogo-redaktora-ot-cms-dfdx.php");
