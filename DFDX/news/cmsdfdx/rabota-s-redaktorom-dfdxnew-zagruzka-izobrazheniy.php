...
//файл сгенерирован CMS-DFDX 2022-02-09 23:10:19
//file generated CMS-DFDX 2022-02-09 23:10:19
session_start();
include "../../funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>Работа с редактором DFDX (news1). Загрузка изображений.</title>');
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=27;
        $metka='rabota-s-redaktorom-dfdxnew-zagruzka-izobrazheniy-'; //метка для счётчика статистики посещения конкретной страницы
        //$nomerNewsPoisk='Число_статей=5';
        //$nomerNewsGlawn='Число_статей=5';

        $nonTemplates->publishNews($redaktor,'action=#','Число_статей=5');
...
buttonTwitter("Работа с редактором DFDX (news1). Загрузка изображений. http://dfdx.uxp.ru/news/cmsdfdx/rabota-s-redaktorom-dfdxnew-zagruzka-izobrazheniy.php");
