...
//файл сгенерирован CMS-DFDX 2022-03-06 01:27:58
//file generated CMS-DFDX 2022-03-06 01:27:58
session_start();
...
echo '<head>';
  ...
  $header->headStart('<title>27</title>');
...
$metka='rabota-s-redaktorom-dfdxnew-zagruzka-izobrazheniy-'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',27,$nameBD,'#категория для поиска#','Раздел=regular_expressions','27 http://dfdx.uxp.ru/news/cmsdfdx/rabota-s-redaktorom-dfdxnew-zagruzka-izobrazheniy.php');
