...
//файл сгенерирован CMS-DFDX 2022-03-06 10:08:40
//file generated CMS-DFDX 2022-03-06 10:08:40
session_start();
...
echo '<head>';
  ...
  $header->headStart('<title>14</title>');
...
$metka='registraciya-administratora-na-sayte-s-cms-dfdx'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',14,$nameBD,'#категория для поиска#','Раздел=regular_expressions','14 http://dfdx.uxp.ru/news/cmsdfdx/registraciya-administratora-na-sayte-s-cms-dfdx.php');
