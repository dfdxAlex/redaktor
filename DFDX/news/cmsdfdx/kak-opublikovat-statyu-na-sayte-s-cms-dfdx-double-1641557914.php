...
<title>Как опубликовать статью на сайте с CMS-DFDX.</title>
...
$runNewsIsNews1=15;
$metka='kak-opublikovat-statyu-na-sayte-s-cms-dfdx-'; //метка для счётчика статистики посещения конкретной страницы
...
//маркер
 if (!$bylPoisk)
 {
  ...
  buttonTwitter("Как опубликовать статью на сайте с CMS-DFDX. http://dfdx.uxp.ru/news/cmsdfdx/kak-opublikovat-statyu-na-sayte-s-cms-dfdx-double-1641557914.php");
