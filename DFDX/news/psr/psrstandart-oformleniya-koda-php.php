...
echo '<head>';
  ...
  $header->headStart('<title>25</title>');
...
$metka='psrstandart-oformleniya-koda-php-'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',25,$nameBD,'#категория для поиска#','Раздел=regular_expressions','25 http://dfdx.uxp.ru/news/psr/psrstandart-oformleniya-koda-php.php');
