...
<title>Стандарт PSR-0, помечен как устаревший.</title>
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=20;
        $metka='standart-psrpomechen-kak-ustarevshiy-'; //метка для счётчика статистики посещения конкретной страницы
        ...
        if (!$bylPoisk) {
          ...
          buttonTwitter("Стандарт PSR-0, помечен как устаревший. http://dfdx.uxp.ru/news/psr/standart-psrpomechen-kak-ustarevshiy.php");
