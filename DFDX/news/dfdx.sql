...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 26 2021 г., 18:03
...
(2, 'rdNowaStr', 254),
(3, 'nastrNowaStranica', 86),
(7, 'dfdx', 1782),
(8, 'html', 839),
(9, 'html5', 254),
(10, 'regular_expressions', 590),
(11, 'cms-dfdx', 9),
(12, 'cms-dfdx.php', 2),
(13, 'html7', 2),
(14, 'cms_dfdx', 19),
...
('boeslav', '123123', '890', 1, 1628871956),
('Liutik', 'q100600Q', 'Liut', 78538, 1628876110),
('Indi', 'August1978', 'kuzhe', 1, 1628888529),
...
CREATE TABLE `vernul_statii_dfdx` (
  `id` int(11) DEFAULT NULL,
  `komment` varchar(500) COLLATE utf32_bin DEFAULT NULL
