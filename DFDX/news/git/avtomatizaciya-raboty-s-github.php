...
//файл сгенерирован CMS-DFDX 2022-02-09 23:37:52
//file generated CMS-DFDX 2022-02-09 23:37:52
session_start();
include "../../funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>Автоматизация работы с GitHub</title>');
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        //$runNewsIsNews1=-1;
        $metka='avtomatizaciya-raboty-s-github'; //метка для счётчика статистики посещения конкретной страницы
        //$nomerNewsPoisk='Число_статей=5';
        //$nomerNewsGlawn='Число_статей=5';

        $nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',23);
...
buttonTwitter("Автоматизация работы с GitHub http://dfdx.uxp.ru/news/git/avtomatizaciya-raboty-s-github.php");
