...
$runNewsIsNews1=19;
$metka='generaciya-ssh-klyucha-i-dobavlenie-ego-v-githab-'; //метка для счётчика статистики посещения конкретной страницы
...
//маркер
 if (!$bylPoisk)
 {
  ...
  buttonTwitter("Генерация SSH ключа и добавление его в GitHab. http://dfdx.uxp.ru/news/git/generaciya-ssh-klyucha-i-dobavlenie-ego-v-githab-double-1641495946.php");
