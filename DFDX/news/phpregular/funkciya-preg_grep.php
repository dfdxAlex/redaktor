...
echo '<head>';
  ...
  $header->headStart('<title>6</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',6,$nameBD,'#категория для поиска#','Раздел=regular_expressions','6 http://dfdx.uxp.ru/news/phpregular/funkciya-preg_grep.php');
