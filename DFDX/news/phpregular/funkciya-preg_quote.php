...
<title>Функция preg_quote()</title>
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=5;
        $metka='funkciya-preg_quote'; //метка для счётчика статистики посещения конкретной страницы
        ...
        if (!$bylPoisk) {
          ...
          buttonTwitter("Функция preg_quote() http://dfdx.uxp.ru/news/phpregular/funkciya-preg_quote.php");
