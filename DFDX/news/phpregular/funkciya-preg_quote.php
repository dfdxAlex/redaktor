...
echo '<head>';
  ...
  $header->headStart('<title>5</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',5,$nameBD,'#категория для поиска#','Раздел=regular_expressions','5 http://dfdx.uxp.ru/news/phpregular/funkciya-preg_quote.php');
