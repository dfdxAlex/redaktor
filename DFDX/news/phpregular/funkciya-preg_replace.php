...
//файл сгенерирован CMS-DFDX 2022-02-07 20:46:24
//file generated CMS-DFDX 2022-02-07 20:46:24
session_start();
include "../../funcii.php";
...
<title>Функция preg_replace().</title>
...
echo '<section class="container-fluid pole">';
    echo '<div class="row">';
        ...
        $runNewsIsNews1=10;
        $metka='funkciya-preg_replace-'; //метка для счётчика статистики посещения конкретной страницы
        ...
        if (!$bylPoisk) {
          ...
          buttonTwitter("Функция preg_replace(). http://dfdx.uxp.ru/news/phpregular/funkciya-preg_replace.php");
