...
echo '<head>';
  ...
  $header->headStart('<title>12</title>');
...
$metka='preg_replace_callback_arrayphp'; 
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',12,$nameBD,'#категория для поиска#','Раздел=regular_expressions','12 http://dfdx.uxp.ru/news/phpregular/preg_replace_callback_arrayphp.php');
