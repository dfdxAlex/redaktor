...
//файл сгенерирован CMS-DFDX 2022-03-06 01:40:17
//file generated CMS-DFDX 2022-03-06 01:40:17
session_start();
...
echo '<head>';
  ...
  $header->headStart('<title>4</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',4,$nameBD,'#категория для поиска#','Раздел=regular_expressions','4 http://dfdx.uxp.ru/news/phpregular/funkciya-preg_filter.php');
