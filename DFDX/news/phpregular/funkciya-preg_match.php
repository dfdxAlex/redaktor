...
echo '<head>';
  ...
  $header->headStart('<title>7</title>');
...
$nonTemplates->publishNews($redaktor,'action=#','Число_статей=5',7,$nameBD,'#категория для поиска#','Раздел=regular_expressions','7 http://dfdx.uxp.ru/news/phpregular/funkciya-preg_match.php');
