...
//файл сгенерирован CMS-DFDX 2022-02-13 23:56:44
//file generated CMS-DFDX 2022-02-13 23:56:44
session_start();
require "funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>xhtml</title>');
...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('image/home.png','xhtml');   
...
$metka="xhtml"; //метка для счётчика статистики посещения конкретной страницы
...
$nonTemplates->publishNews($redaktor,'action=xhtml.php','Число_статей=5',-1,$nameBD,'категория-xhtml','Раздел=xhtml','buttonTwitter');
