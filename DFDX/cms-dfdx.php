...
//файл сгенерирован CMS-DFDX 2022-02-13 23:48:00
//file generated CMS-DFDX 2022-02-13 23:48:00
session_start();
require "funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>cmsdfdx</title>');
...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('image/home.png','cmsdfdx');   
...
$metka="cmsdfdx"; //метка для счётчика статистики посещения конкретной страницы
