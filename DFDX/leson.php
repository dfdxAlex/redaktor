...
//файл сгенерирован CMS-DFDX 2022-02-13 23:59:44
//file generated CMS-DFDX 2022-02-13 23:59:44
session_start();
require "funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>leson</title>');
...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('image/home.png','leson');   
...
$metka="leson"; //метка для счётчика статистики посещения конкретной страницы
...
$nonTemplates->publishNews($redaktor,'action=leson.php','Число_статей=5',-1,$nameBD,'категория-leson','Раздел=leson','buttonTwitter');
