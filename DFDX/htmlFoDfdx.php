...
//файл сгенерирован CMS-DFDX 2022-02-13 23:51:50
//file generated CMS-DFDX 2022-02-13 23:51:50
session_start();
require "funcii.php";
...
echo '<head>';
  ...
  $header->headStart('<title>html3</title>');
...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('image/home.png','html3');   
...
$metka="html3"; //метка для счётчика статистики посещения конкретной страницы
...
$nonTemplates->publishNews($redaktor,'action=htmlFoDfdx.php','Число_статей=5',-1,$nameBD,'категория-html3','Раздел=html3','buttonTwitter');
