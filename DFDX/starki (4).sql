...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 13 2021 г., 23:06
...
--
-- Структура таблицы `bazy_federacii`
--

CREATE TABLE `bazy_federacii` (
  `ID` int(11) DEFAULT NULL,
  `kory` varchar(55) COLLATE utf8_bin DEFAULT NULL,
  `login_dobavil` varchar(55) COLLATE utf8_bin DEFAULT NULL,
  `login_proveril` varchar(55) COLLATE utf8_bin DEFAULT NULL,
  `provereno` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Дамп данных таблицы `bazy_federacii`
--

INSERT INTO `bazy_federacii` (`ID`, `kory`, `login_dobavil`, `login_proveril`, `provereno`) VALUES
(1, '40245-10195', 'alex25', 'alfa54', 1),
(2, '39184-12145', 'alfa54', '', 0),
(3, '40504-10386', 'alfa54', '', 0),
(4, '39928-10477', 'alfa54', '', 0),
(5, '40267-10202', 'alfa54', '', 0);
...
(0, 'О членах клана', 'starki.php', 'login_stark btn', '-12345'),
(1, 'Устав клана', 'starki.php', 'login_stark btn', '-12345'),
(2, 'Мы на Ютубе', 'starki.php', 'login_stark btn', '-012345'),
(3, 'Наши проекты', 'starki.php', 'login_stark btn', '-12345'),
...
(8, 'Наши модули', 'starki.php', 'login_stark btn', '-12345'),
(9, 'Поиск баз', 'starki.php', 'login_stark btn', '-12345');
...
--
-- Структура таблицы `myzonebazaboeslav`
--

CREATE TABLE `myzonebazaboeslav` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
(0, 'иди на**', 'ыаперыапап', 'alex25'),
(1, 'иди на**', 'atvdf asdv asdcf sdfc sdc sd <br>\r\n%Железная руда%%Органическое топливо%%Ядерное топливо%\r\n%Термоядерное топливо%%Гравитационное топливо%%Полиорганическая руда%%Полиэлементная руда%%Уран%%Митрацит%%Иридиум%%Крокит%%Брадий%%Титанит%%Ноксикум%%Изидрит%%Сероний%%Зукрит%%Миланокс%%Орекс%%Заброзин%%Квантиум%%Левиум%%Гелий-3%%Темная материя%%Матоварка%', 'alex25');
...
--
-- Дамп данных таблицы `my_zone_bazaalfa54`
--

INSERT INTO `my_zone_bazaalfa54` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'база', 'база', 'alfa54');

-- --------------------------------------------------------

--
-- Структура таблицы `my_zone_bazaanchorte`
--

CREATE TABLE `my_zone_bazaanchorte` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
--
-- Структура таблицы `my_zone_bazastark2`
--

CREATE TABLE `my_zone_bazastark2` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
--
-- Дамп данных таблицы `my_zone_freealfa54`
--

INSERT INTO `my_zone_freealfa54` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'разное', 'разное', 'alfa54');
...
--
-- Дамп данных таблицы `my_zone_freenyna`
--

INSERT INTO `my_zone_freenyna` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'иди на**', 'xdfcxcv', 'Nyna'),
(1, 'иди на**', 'разное', 'Nyna');

-- --------------------------------------------------------

--
-- Структура таблицы `my_zone_freestark2`
--

CREATE TABLE `my_zone_freestark2` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
--
-- Структура таблицы `my_zone_proect`
--

CREATE TABLE `my_zone_proect` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
--
-- Дамп данных таблицы `my_zone_proectalex25`
--

INSERT INTO `my_zone_proectalex25` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'Проектируем археолога.', 'ыкнрапракпр', 'alex25');
...
--
-- Дамп данных таблицы `my_zone_proectalfa54`
--

INSERT INTO `my_zone_proectalfa54` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'проект', 'проект', 'alfa54');
...
--
-- Дамп данных таблицы `my_zone_proectnyna`
--

INSERT INTO `my_zone_proectnyna` (`id`, `name`, `news`, `login_redaktora`) VALUES
(0, 'иди на**', 'вам', 'Nyna');

-- --------------------------------------------------------

--
-- Структура таблицы `my_zone_proectstark2`
--

CREATE TABLE `my_zone_proectstark2` (
  `id` int(11) DEFAULT NULL,
  `name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `news` mediumtext COLLATE utf8_bin DEFAULT NULL,
  `login_redaktora` varchar(200) COLLATE utf8_bin DEFAULT NULL
...
--
-- Структура таблицы `pokaz_modul`
--

CREATE TABLE `pokaz_modul` (
  `ID` int(11) DEFAULT NULL,
  `NAME` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `URL` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `CLASS` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Дамп данных таблицы `pokaz_modul`
--

INSERT INTO `pokaz_modul` (`ID`, `NAME`, `URL`, `CLASS`, `STATUS`) VALUES
(0, 'Все', 'starki.php', 'class_rasy_stark_vse_modul_pokaz btn', '-12345'),
(1, 'Гелионы', 'starki.php', 'class_rasy_stark_gelion_modul_pokaz btn', '-12345'),
(2, 'Зект', 'starki.php', 'class_rasy_stark_zekt_modul_pokaz btn', '-12345'),
(3, 'Тормаль', 'starki.php', 'class_rasy_stark_tormal_modul_pokaz btn', '-12345'),
(4, 'Велид', 'starki.php', 'class_rasy_stark_velid_modul_pokaz btn', '-12345'),
(5, 'Гларг', 'starki.php', 'class_rasy_stark_glarg_modul_pokaz btn', '-12345'),
(6, 'Астокс', 'starki.php', 'class_rasy_stark_astoks_modul_pokaz btn', '-12345'),
(7, 'Мрун', 'starki.php', 'class_rasy_stark_mroon_modul_pokaz btn', '-12345');
...
(1, 'Я могу всё', 'p', 'prawa_dolgnost_p', '-s12345'),
...
(11, 'Круглое часто носят', 'redaktor.php', 'registracia btn btn-info'),
(12, 'Зеньки раскрой зараза', 'redaktor.php', 'registracia btn btn-info'),
(13, 'Ваньку валяли в полдень', 'redaktor.php', 'registracia btn btn-info'),
(14, 'Больше не буду плакать', 'redaktor.php', 'registracia btn btn-info'),
...
(11, 'Zwanie_boeslav', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(12, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(13, 'boeslav', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(14, '<<<     boeslav', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(15, '^1     boeslav', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(16, '^10     boeslav', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(17, '^20     boeslav', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(18, 'Сохранить boeslav', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(19, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(20, 'Zwanie_Indi', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(21, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
...
(29, 'Zwanie_alex25', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(30, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(31, 'alex25', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(32, '<<<     alex25', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(33, '^1     alex25', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(34, '^10     alex25', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(35, '^20     alex25', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(36, 'Сохранить alex25', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(37, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(38, 'Zwanie_Stark2', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(39, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(40, 'Stark2', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(41, '<<<     Stark2', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(42, '^1     Stark2', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(43, '^10     Stark2', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(44, '^20     Stark2', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(45, 'Сохранить Stark2', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(46, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(47, 'Zwanie_Han_Solo', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(48, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(49, 'Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(50, '<<<     Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(51, '^1     Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(52, '^10     Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(53, '^20     Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(54, 'Сохранить Han_Solo', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(55, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(56, 'Zwanie_Nyna', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(57, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(58, 'Nyna', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(59, '<<<     Nyna', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(60, '^1     Nyna', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(61, '^10     Nyna', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(62, '^20     Nyna', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(63, 'Сохранить Nyna', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(64, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(65, 'Zwanie_drewniy', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(66, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(67, 'drewniy', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(68, '<<<     drewniy', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(69, '^1     drewniy', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(70, '^10     drewniy', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(71, '^20     drewniy', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(72, 'Сохранить drewniy', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(73, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(74, 'Zwanie_Anchorte', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(75, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(76, 'Anchorte', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(77, '<<<     Anchorte', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(78, '^1     Anchorte', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(79, '^10     Anchorte', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(80, '^20     Anchorte', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(81, 'Сохранить Anchorte', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(82, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(83, 'Zwanie_supertony', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(84, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(85, 'supertony', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(86, '<<<     supertony', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(87, '^1     supertony', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(88, '^10     supertony', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(89, '^20     supertony', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(90, 'Сохранить supertony', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(91, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(92, 'Zwanie_Vasilisk', 'text2', 'strarki_menu_dolgnosti_text2', '-s45'),
(93, ' ', 'starki.php', 'strarki_menu_dolgnosti_prefix btn', '-s123'),
(94, 'Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_login btn', '-s0123459'),
(95, '<<<     Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_down btn', '-s45'),
(96, '^1     Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_up1 btn', '-s45'),
(97, '^10     Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_up10 btn', '-s45'),
(98, '^20     Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_up20 btn', '-s45'),
(99, 'Сохранить Vasilisk', 'starki.php', 'strarki_menu_dolgnosti_save btn', '-s45'),
(100, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s0123459'),
(101, 'Изменить ширину меню', 'starki.php', 'strarki_menu_dolgnosti_rashirit btn', '-s45'),
(102, 'br', 'text', 'strarki_menu_dolgnosti_br', '-s45'),
(103, 'Меню описания должностей', 'starki.php', 'strarki_menu_dolgnosti_rashirit btn', '-s45');
...
CREATE TABLE `tab_modul` (
  `id` int(11) DEFAULT NULL,
  `login` varchar(55) COLLATE utf8_bin DEFAULT NULL,
  `name_modul` varchar(155) COLLATE utf8_bin DEFAULT NULL,
  `levl_modul` int(11) DEFAULT NULL,
  `rasa` varchar(35) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(0, 'login', 'modul', 1000, 'rasa'),
(1, 'Nyna', 'Буровая платформа МД-1', 2000, 'zekt'),
(2, 'Nyna', 'ыкерке', 1000, 'zekt'),
(3, 'Nyna', 'ыкерке', 1000, 'zekt'),
(4, 'Nyna', 'гелион3', 1000, 'zekt'),
(5, 'Nyna', 'зект', 1000, 'zekt'),
(6, 'alex25', 'Грузовая платформа', 5, 'tormal'),
(7, 'alex25', 'гелион3', 441, 'tormal');
