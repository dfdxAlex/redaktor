...
$header->showSiteHeader('image/logo.png');
 ...
 $header->showSiteSection('../image/home.png','programToPhp');   
...
$metka="programToPhp"; //метка для счётчика статистики посещения конкретной страницы
...
//$nonTemplates->publishNews($redaktor,'action=programToPhp.php','Число_статей=5',-1,$nameBD,'категория-gamesOfPhp','Раздел=programToPhp','buttonTwitter');
