    ...
    function formLoad()
    {
        ...
        <div class="load-foto-form">
            <section class="container-fluid">
                <div class="row">
                    <p class="mesage-load-foto">'. (string) new Translation("Ссылка на картинку").'</p>
                </div>
                <div class="row">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <label class="field__file-wrapper" for="field__file-2">
                      <div class="field__file-fake">'. (string) new Translation("Выбрать фотографию").'</div>
                      <div class="field__file-button">'. (string) new Translation("Выбрать").'</div>
                    </label>
                    </div>
                    </div>
